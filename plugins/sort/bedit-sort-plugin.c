...
static void get_current_selection(BeditSortPlugin *plugin) {
    BeditSortPluginPrivate *priv;
    BeditDocument *doc;
...
static void create_sort_dialog(BeditSortPlugin *plugin) {
    BeditSortPluginPrivate *priv;
    GtkBuilder *builder;
...
static void update_ui(BeditSortPlugin *plugin) {
    BeditView *view;
...
static void bedit_sort_plugin_app_deactivate(BeditAppActivatable *activatable) {
    BeditSortPluginPrivate *priv;
...
static void bedit_sort_plugin_finalize(GObject *object) {
...
static void bedit_sort_plugin_class_init(BeditSortPluginClass *klass) {
