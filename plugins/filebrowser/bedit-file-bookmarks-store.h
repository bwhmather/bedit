...
#define GEDIT_FILE_BOOKMARKS_STORE(obj)                                        \
    (G_TYPE_CHECK_INSTANCE_CAST(                                               \
        (obj), GEDIT_TYPE_FILE_BOOKMARKS_STORE, BeditFileBookmarksStore))
#define GEDIT_FILE_BOOKMARKS_STORE_CONST(obj)                                  \
    (G_TYPE_CHECK_INSTANCE_CAST(                                               \
        (obj), GEDIT_TYPE_FILE_BOOKMARKS_STORE,                                \
        BeditFileBookmarksStore const))
#define GEDIT_FILE_BOOKMARKS_STORE_CLASS(klass)                                \
    (G_TYPE_CHECK_CLASS_CAST(                                                  \
        (klass), GEDIT_TYPE_FILE_BOOKMARKS_STORE,                              \
        BeditFileBookmarksStoreClass))
#define GEDIT_IS_FILE_BOOKMARKS_STORE(obj)                                     \
    (G_TYPE_CHECK_INSTANCE_TYPE((obj), GEDIT_TYPE_FILE_BOOKMARKS_STORE))
#define GEDIT_IS_FILE_BOOKMARKS_STORE_CLASS(klass)                             \
    (G_TYPE_CHECK_CLASS_TYPE((klass), GEDIT_TYPE_FILE_BOOKMARKS_STORE))
#define GEDIT_FILE_BOOKMARKS_STORE_GET_CLASS(obj)                              \
    (G_TYPE_INSTANCE_GET_CLASS(                                                \
        (obj), GEDIT_TYPE_FILE_BOOKMARKS_STORE, BeditFileBookmarksStoreClass))
...
enum {
    ...
    GEDIT_FILE_BOOKMARKS_STORE_IS_HOME = 1
        << 2, /* The special Home user directory */
    GEDIT_FILE_BOOKMARKS_STORE_IS_DESKTOP = 1
        << 3, /* The special Desktop user directory */
    GEDIT_FILE_BOOKMARKS_STORE_IS_DOCUMENTS = 1
    ...
    GEDIT_FILE_BOOKMARKS_STORE_IS_ROOT = 1
        << 9, /* The root file system (file:///) */
    GEDIT_FILE_BOOKMARKS_STORE_IS_BOOKMARK = 1 << 10, /* A gtk bookmark */
    GEDIT_FILE_BOOKMARKS_STORE_IS_REMOTE_BOOKMARK = 1
        << 11, /* A remote gtk bookmark */
    GEDIT_FILE_BOOKMARKS_STORE_IS_LOCAL_BOOKMARK = 1
