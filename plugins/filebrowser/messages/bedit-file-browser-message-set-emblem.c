...
static void bedit_file_browser_message_set_emblem_finalize(GObject *obj) {
    ...
    G_OBJECT_CLASS(bedit_file_browser_message_set_emblem_parent_class)
        ->finalize(obj);
}

static void bedit_file_browser_message_set_emblem_get_property(
...
static void bedit_file_browser_message_set_emblem_set_property(
...
static void bedit_file_browser_message_set_emblem_class_init(
    BeditFileBrowserMessageSetEmblemClass *klass
) {
    ...
    object_class->get_property =
        bedit_file_browser_message_set_emblem_get_property;
    object_class->set_property =
        bedit_file_browser_message_set_emblem_set_property;
    ...
    g_object_class_install_property(
        object_class, PROP_EMBLEM,
        g_param_spec_string(
            "emblem", "Emblem", "Emblem", NULL,
            G_PARAM_READWRITE | G_PARAM_CONSTRUCT | G_PARAM_STATIC_STRINGS
        )
    );
}

static void bedit_file_browser_message_set_emblem_init(
    BeditFileBrowserMessageSetEmblem *message
) {
    message->priv =
        bedit_file_browser_message_set_emblem_get_instance_private(message);
}
