...
#define GEDIT_TYPE_FILE_BROWSER_MESSAGE_EXTEND_CONTEXT_MENU            (bedit_file_browser_message_extend_context_menu_get_type ())
...
GType bedit_file_browser_message_extend_context_menu_get_type (void) G_GNUC_CONST;
