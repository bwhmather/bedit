...
static void update_selection_info(
    ...
    if (sel) {
        lines =
            gtk_text_iter_get_line(&end) - gtk_text_iter_get_line(&start) + 1;
...
static void create_docinfo_dialog(BeditDocinfoPlugin *plugin) {
    BeditDocinfoPluginPrivate *priv;
    GtkBuilder *builder;
...
static void bedit_docinfo_plugin_init(BeditDocinfoPlugin *plugin) {
...
static void bedit_docinfo_plugin_finalize(GObject *object) {
...
static void update_ui(BeditDocinfoPlugin *plugin) {
    BeditDocinfoPluginPrivate *priv;
    BeditView *view;
