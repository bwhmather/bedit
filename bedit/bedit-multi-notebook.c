...
G_DEFINE_TYPE_WITH_PRIVATE (BeditMultiNotebook, bedit_multi_notebook, GTK_TYPE_GRID)

static void	remove_notebook		(BeditMultiNotebook *mnb,
					 GtkWidget          *notebook);

static void	update_tabs_visibility	(BeditMultiNotebook *mnb);

static void
bedit_multi_notebook_get_property (GObject    *object,
				   guint       prop_id,
				   GValue     *value,
				   GParamSpec *pspec)
{
...
static void
bedit_multi_notebook_set_property (GObject      *object,
				   guint         prop_id,
				   const GValue *value,
				   GParamSpec   *pspec)
{
...
static void
bedit_multi_notebook_dispose (GObject *object)
{
	BeditMultiNotebook *mnb = GEDIT_MULTI_NOTEBOOK (object);
...
static void
bedit_multi_notebook_finalize (GObject *object)
{
	BeditMultiNotebook *mnb = GEDIT_MULTI_NOTEBOOK (object);
...
static void
bedit_multi_notebook_class_init (BeditMultiNotebookClass *klass)
{
	...
	signals[NOTEBOOK_ADDED] =
		g_signal_new ("notebook-added",
			      ...
			      G_SIGNAL_RUN_FIRST,
			      G_STRUCT_OFFSET (BeditMultiNotebookClass, notebook_added),
			      NULL, NULL, NULL,
			      G_TYPE_NONE,
			      1,
			      GEDIT_TYPE_NOTEBOOK);
	signals[NOTEBOOK_REMOVED] =
		g_signal_new ("notebook-removed",
			      G_OBJECT_CLASS_TYPE (object_class),
			      G_SIGNAL_RUN_FIRST,
			      G_STRUCT_OFFSET (BeditMultiNotebookClass, notebook_removed),
			      NULL, NULL, NULL,
			      G_TYPE_NONE,
			      1,
			      GEDIT_TYPE_NOTEBOOK);
	signals[TAB_ADDED] =
		g_signal_new ("tab-added",
			      G_OBJECT_CLASS_TYPE (object_class),
			      G_SIGNAL_RUN_FIRST,
			      G_STRUCT_OFFSET (BeditMultiNotebookClass, tab_added),
			      NULL, NULL, NULL,
			      G_TYPE_NONE,
			      2,
			      GEDIT_TYPE_NOTEBOOK,
	...
	signals[TAB_REMOVED] =
		g_signal_new ("tab-removed",
			      G_OBJECT_CLASS_TYPE (object_class),
			      G_SIGNAL_RUN_FIRST,
			      G_STRUCT_OFFSET (BeditMultiNotebookClass, tab_removed),
			      NULL, NULL, NULL,
			      G_TYPE_NONE,
			      2,
			      GEDIT_TYPE_NOTEBOOK,
	...
	signals[SWITCH_TAB] =
		g_signal_new ("switch-tab",
			      G_OBJECT_CLASS_TYPE (object_class),
			      G_SIGNAL_RUN_FIRST,
			      G_STRUCT_OFFSET (BeditMultiNotebookClass, switch_tab),
			      NULL, NULL, NULL,
			      G_TYPE_NONE,
			      4,
			      GEDIT_TYPE_NOTEBOOK,
	...
	signals[TAB_CLOSE_REQUEST] =
		g_signal_new ("tab-close-request",
			      G_OBJECT_CLASS_TYPE (object_class),
			      G_SIGNAL_RUN_FIRST,
			      G_STRUCT_OFFSET (BeditMultiNotebookClass, tab_close_request),
			      NULL, NULL, NULL,
			      G_TYPE_NONE,
			      2,
			      GEDIT_TYPE_NOTEBOOK,
	...
	signals[CREATE_WINDOW] =
		g_signal_new ("create-window",
		              ...
		              G_SIGNAL_RUN_LAST,
		              G_STRUCT_OFFSET (BeditMultiNotebookClass, create_window),
		              NULL, NULL, NULL,
		              GTK_TYPE_NOTEBOOK, 4,
	...
	signals[PAGE_REORDERED] =
		g_signal_new ("page-reordered",
		              G_OBJECT_CLASS_TYPE (object_class),
		              G_SIGNAL_RUN_FIRST,
		              G_STRUCT_OFFSET (BeditMultiNotebookClass, page_reordered),
		              NULL, NULL, NULL,
		              G_TYPE_NONE,
		              3,
		              GEDIT_TYPE_NOTEBOOK, GTK_TYPE_WIDGET,
	...
	signals[SHOW_POPUP_MENU] =
		g_signal_new ("show-popup-menu",
			      G_OBJECT_CLASS_TYPE (object_class),
			      G_SIGNAL_RUN_FIRST,
			      G_STRUCT_OFFSET (BeditMultiNotebookClass, show_popup_menu),
			      NULL, NULL, NULL,
			      G_TYPE_NONE,
			      2,
...
static void
notebook_tab_close_request (BeditNotebook      *notebook,
			    BeditTab           *tab,
			    BeditMultiNotebook *mnb)
{
...
static GtkNotebook *
notebook_create_window (BeditNotebook      *notebook,
			GtkWidget          *child,
			gint                x,
			gint                y,
			BeditMultiNotebook *mnb)
...
static void
notebook_page_reordered (BeditNotebook      *notebook,
		         GtkWidget          *child,
		         guint               page_num,
		         BeditMultiNotebook *mnb)
{
...
static void
set_active_tab (BeditMultiNotebook *mnb,
                BeditTab           *tab)
{
...
static void
update_tabs_visibility (BeditMultiNotebook *mnb)
{
	gboolean show_tabs;
	GList *l;
...
static void
connect_notebook_signals (BeditMultiNotebook *mnb,
			  GtkWidget          *notebook)
{
...
static void
disconnect_notebook_signals (BeditMultiNotebook *mnb,
			     GtkWidget          *notebook)
{
...
static void
add_notebook (BeditMultiNotebook *mnb,
	      GtkWidget          *notebook,
...
static void
remove_notebook (BeditMultiNotebook *mnb,
		 GtkWidget          *notebook)
{
	GtkWidget *parent;
	GtkWidget *grandpa;
...
static void
bedit_multi_notebook_init (BeditMultiNotebook *mnb)
{
...
BeditMultiNotebook *
bedit_multi_notebook_new ()
{
	return g_object_new (GEDIT_TYPE_MULTI_NOTEBOOK, NULL);
}

BeditNotebook *
bedit_multi_notebook_get_active_notebook (BeditMultiNotebook *mnb)
{
...
gint
bedit_multi_notebook_get_n_notebooks (BeditMultiNotebook *mnb)
{
...
BeditNotebook *
bedit_multi_notebook_get_nth_notebook (BeditMultiNotebook *mnb,
				       gint                notebook_num)
{
	g_return_val_if_fail (GEDIT_IS_MULTI_NOTEBOOK (mnb), NULL);
...
BeditNotebook *
bedit_multi_notebook_get_notebook_for_tab (BeditMultiNotebook *mnb,
                                           BeditTab           *tab)
{
	GList *l;
	gint page_num;
...
gint
bedit_multi_notebook_get_notebook_num (BeditMultiNotebook *mnb,
...
gint
bedit_multi_notebook_get_n_tabs (BeditMultiNotebook *mnb)
{
	g_return_val_if_fail (GEDIT_IS_MULTI_NOTEBOOK (mnb), 0);
...
gint
bedit_multi_notebook_get_page_num (BeditMultiNotebook *mnb,
				   BeditTab           *tab)
{
	GList *l;
...
BeditTab *
bedit_multi_notebook_get_active_tab (BeditMultiNotebook *mnb)
{
	g_return_val_if_fail (GEDIT_IS_MULTI_NOTEBOOK (mnb), NULL);
...
void
bedit_multi_notebook_set_active_tab (BeditMultiNotebook *mnb,
				     BeditTab           *tab)
{
	GList *l;
	gint page_num;
...
void
bedit_multi_notebook_set_current_page (BeditMultiNotebook *mnb,
				       gint                page_num)
{
	GList *l;
	gint pages = 0;
...
GList *
bedit_multi_notebook_get_all_tabs (BeditMultiNotebook *mnb)
{
	GList *nbs;
	GList *ret = NULL;
...
void
bedit_multi_notebook_close_tabs (BeditMultiNotebook *mnb,
				 const GList        *tabs)
{
	GList *l;
 ...
 */
void
bedit_multi_notebook_close_all_tabs (BeditMultiNotebook *mnb)
{
	GList *nbs, *l;
...
void
bedit_multi_notebook_add_new_notebook (BeditMultiNotebook *mnb)
{
	GtkWidget *notebook;
	BeditTab *tab;
...
void
bedit_multi_notebook_add_new_notebook_with_tab (BeditMultiNotebook *mnb,
                                                BeditTab           *tab)
{
	GtkWidget *notebook;
...
void
bedit_multi_notebook_remove_active_notebook (BeditMultiNotebook *mnb)
{
	g_return_if_fail (GEDIT_IS_MULTI_NOTEBOOK (mnb));
...
void
bedit_multi_notebook_previous_notebook (BeditMultiNotebook *mnb)
{
	GList *current;
	GtkWidget *notebook;
...
void
bedit_multi_notebook_next_notebook (BeditMultiNotebook *mnb)
{
	GList *current;
	GtkWidget *notebook;
...
void
bedit_multi_notebook_foreach_notebook (BeditMultiNotebook *mnb,
...
void
bedit_multi_notebook_foreach_tab (BeditMultiNotebook *mnb,
				  GtkCallback         callback,
				  gpointer            callback_data)
{
	GList *nb;
 ...
 */
void
_bedit_multi_notebook_set_show_tabs (BeditMultiNotebook *mnb,
				     gboolean           show)
{
	g_return_if_fail (GEDIT_IS_MULTI_NOTEBOOK (mnb));
