...
void
_bedit_cmd_help_keyboard_shortcuts (BeditWindow *window)
{
	...
	if (shortcuts_window == NULL)
	{
		...
		builder = gtk_builder_new_from_resource ("/com/bwhmather/bedit/ui/bedit-shortcuts.ui");
		shortcuts_window = GTK_WIDGET (gtk_builder_get_object (builder, "shortcuts-bedit"));
...
void
_bedit_cmd_help_contents (BeditWindow *window)
{
	bedit_debug (DEBUG_COMMANDS);
...
void
_bedit_cmd_help_about (BeditWindow *window)
{
	...
	static const gchar copyright[] = "Copyright \xc2\xa9 1998-2019 - the bedit team";

	static const gchar comments[] = \
		N_("bedit is a small and lightweight text editor for the GNOME Desktop");
	...
	logo = gdk_pixbuf_new_from_resource ("/com/bwhmather/bedit/pixmaps/bedit-logo.png", &error);
	if (error != NULL)
	{
	...
	gtk_show_about_dialog (GTK_WINDOW (window),
			       ...
			       "version", VERSION,
			       "website", "http://www.bedit.org",
			       "website-label", "www.bedit.org",
			       NULL);
